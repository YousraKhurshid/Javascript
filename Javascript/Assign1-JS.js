...
// var anyInput = prompt ("What is your weight in Pounds?" )
...
//    if((num1) < (num2)) 
//      { 
//      console.log("The Smaller is "+ num1 + ".");
//      }   
//    else
//      if((num2) < (num1)) 
//      {
//      console.log("The Smaller is "+ num2+ ".");
//      }                  
//    else
//      {
//       console.log("The values are equal.");
//      }
// //Greater than >=
//    var num1 = prompt("Write your kid's age");
//    var num2 = prompt("Write your second kid's age");
//    var myValue = 4
                                                    
//    if((num1) >= (myValue)) 
//      { 
//      console.log("Your Kid is not a toddler because kid's age is "+ num1+ " years.");
//      }   
//    else
//      if((num2) >= (myValue)) 
//      {
//      console.log("Your second Kid is not a toddler because kid's age is "+ num2+ " years.")
//      }                  
//    else
//      {
//       console.log("The kid is a toddler");
//      }
// //Less than equal to <=
//    var num1 = prompt("Write your kid's age");
//    var num2 = prompt("Write your second kid's age");
...
//    if((num1) <= (myValue)) 
//      { 
//      console.log("Your Kid is a toddler of "+ num1+ " year.");
//      }   
//    else
//      if((num2) <= (myValue)) 
//      {
//      console.log("Your Secomd Kid is a toddler of "+ num2+ " year.");
//      }                  
//    else
//      {
//       console.log("The kid is not a toddler.");
//      }
